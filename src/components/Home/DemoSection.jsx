    ...
    <section className="relative">
      ...
      >
        <div
          ...
          style={{
            clipPath:
              "polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.4%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)",
          }}
        />
      </div>
      <div className="flex flex-col items-center text-center space-y-4">
        ...
        <h3 className="font-bold max-w-3xl mx-auto text-center text-3xl px-4 sm:px-6">
          Watch how Sommaire transforms this {' '}
          <span className="bg-linear-to-r from-rose-500 to-rose-700
          bg-clip-text text-transparent"> Next.js course PDF</span>{' '} into an
          easy-to-read summary!
        </h3>
        </div>
        <div className="justify-center items-center px-2 sm:px-4 lg:px-6"></div>
        </div>
      </div>
    </section>
  );
